            ...
            "content": [
                {
                    ...
                    "text":"""
                        ...
                        Response must be in the json format: {"final_status":pass/fail, "message":"short description only"}. 
                        Ensure the response is strictly in this json format and dont send failed/passed in place of fail/pass"""
                },
                {
                    "type": "image_url",
                    "image_url": s3_url
